...
x = []
dea = [[], [], [], [], [], [], [], [], [], [], []]
with open('/Users/tangrui/Documents/dd/dd.md', 'r') as f:
    for line in f:
        if start:
            start_line += 1
        ...
        if start and start_line == 2:
            ...
            for i in range(2, len(fields)):
                titles.append(fields[i].strip().decode('utf-8'))
...
for i in range(0, 11):
    ...
    chart.render_to_file('/Users/tangrui/Documents/dd/dea' + str(i) + '.svg')
...
chart.render_to_file('/Users/tangrui/Documents/dd/comment.svg')

chart = pygal.Line(x_label_rotation=30, human_readable=True)
chart.title = u'作品创建与删除事件'
chart.x_labels = x
chart.add(u'创建', dea[6])
chart.add(u'删除', dea[4])
chart.render_to_file('/Users/tangrui/Documents/dd/musical1.svg')

chart = pygal.Line(x_label_rotation=30, human_readable=True)
chart.title = u'作品点赞与取消点赞事件'
chart.x_labels = x
chart.add(u'点赞', dea[5])
chart.add(u'取消点赞', dea[7])
chart.render_to_file('/Users/tangrui/Documents/dd/musical2.svg')
...
chart.render_to_file('/Users/tangrui/Documents/dd/user.svg')
