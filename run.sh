...
#done
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160628
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160629
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160630
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160701
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160702
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160703
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160704
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160705
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160706
spark-submit --class "com.ctofunds.dd.nginx.PageView" --master "local[4]" target/scala-2.10/dd-assembly-0.0.16.jar data/hicto/access.log-20160707
